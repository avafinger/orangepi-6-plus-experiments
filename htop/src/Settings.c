...
Settings* Settings_new(int cpuCount) {
   ...
   if (rcfile) {
      ...
      char* htopDir = NULL;
      if (xdgConfigHome) {
         this->filename = String_cat(xdgConfigHome, "/htop/htoprc-ngx");
         configDir = xStrdup(xdgConfigHome);
         htopDir = String_cat(xdgConfigHome, "/htop");
      } else {
         this->filename = String_cat(home, "/.config/htop/htoprc-ngx");
         configDir = String_cat(home, "/.config");
         htopDir = String_cat(home, "/.config/htop");
      }
      legacyDotfile = String_cat(home, "/.htoprc-ngx");
   ...
   if (!ok) {
      ...
      char* systemSettings = String_cat(SYSCONFDIR, "/htoprc-ngx");
