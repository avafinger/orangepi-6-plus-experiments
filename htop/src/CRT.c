...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   [COLORSCHEME_DEFAULT] = {
      ...
      [CORE_TEMP] = A_BOLD | ColorPair(Red,Black),
      [CORE_FREQ] = A_BOLD | ColorPair(Yellow,Black),
   },
   ...
   [COLORSCHEME_BLACKONWHITE] = {
      ...
      [CORE_TEMP] = A_BOLD | ColorPair(Red,White),
      [CORE_FREQ] = A_BOLD | ColorPair(Yellow,White),
   },
   ...
   [COLORSCHEME_MIDNIGHT] = {
      ...
      [CORE_TEMP] = A_BOLD | ColorPair(Cyan,Blue),
      [CORE_FREQ] = A_BOLD | ColorPair(Cyan,Blue),
   },
   [COLORSCHEME_BLACKNIGHT] = {
      ...
      [CORE_FREQ] = A_BOLD | ColorPair(Blue,Black),
   },
